...
import { CarrentalOrderComponent } from './carrental-order.component';
...
describe('CarrentalOrderComponent', () => {
  let component: CarrentalOrderComponent;
  let fixture: ComponentFixture<CarrentalOrderComponent>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      declarations: [ CarrentalOrderComponent ],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(CarrentalOrderComponent);
