...
@Component({
  selector: 'app-cruise-dashboard',
  templateUrl: './cruise-dashboard.component.html',
  styleUrls: ['./cruise-dashboard.component.css']
})
export class CruiseDashboardComponent extends Cruise implements OnInit, OnDestroy {
  public response = {};
  public cruiseData = {};
  ...
  serach(){
    if(this.searchFormGroup.valid) {
      ...
      this.router.navigateByUrl('/Cruise/Search');
    } else {
