...
@Component({
  selector: 'app-cruise-orders',
  templateUrl: './cruise-orders.component.html',
  styleUrls: ['./cruise-orders.component.css']
})
export class CruiseOrdersComponent extends Cruise implements OnInit, AfterViewInit  {
  ...
  search() {
    ...
    if(this.searchOrderFG.valid) {
      ...
      this.isLoading = true;
      this.cruiseOrderService.gerOrderByName(value.FirstName, value.LastName).subscribe((data: any) => {
  ...
  searchById() {
    ...
    if(this.searchOrderIdFG.valid) {
      ...
      this.isLoading = true;
      this.cruiseOrderService.gerOrderById(value.OrderId).subscribe((data: any) => {
        // console.log('gerOrderByName');
        // console.log(data);
        this.isLoading = false;
        let order = {
