...
import { CruiseOrderComponent } from './cruise-order.component';
...
describe('CruiseOrderComponent', () => {
  let component: CruiseOrderComponent;
  let fixture: ComponentFixture<CruiseOrderComponent>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      declarations: [ CruiseOrderComponent ],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(CruiseOrderComponent);
