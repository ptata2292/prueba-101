...
@Component({
  selector: 'app-cruise-order',
  templateUrl: './cruise-order.component.html',
  styleUrls: ['./cruise-order.component.css']
})
export class CruiseOrderComponent extends Cruise implements OnInit, AfterViewInit {
  ...
  public cancelOrder() {
    this.isLoading = true;  
    this.cruiseOrderService.cancelOrderById(this.orderId).subscribe((data: any) => {
      // console.log('gerOrderByName');
      // console.log(data);
      this.isLoading = false;  
      this.order = {
