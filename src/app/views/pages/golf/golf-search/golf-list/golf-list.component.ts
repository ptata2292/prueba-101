...
import { GolfItem } from './golf-item/golf-item';
...
export class GolfListComponent extends Golf implements OnInit, AfterViewInit, OnDestroy {
  ...
  constructor(private golfRetrieveService: GolfRetrieveService, private router: Router, 
