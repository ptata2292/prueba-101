...
import { SetSearchCriteriaData } from '../../../../store/golf/golf.actions';
import { GolfStateModule } from '../../../../store/golf/golf.state';
import { MyErrorStateMatcher, trip } from '../../../../shared/models/golf.model';
...
export class GolfSearchComponent extends Golf implements OnInit, AfterViewInit, OnDestroy {
  public response = {};
  public golfData = {};
  public golfLoading = false;
  ...
  @ViewChild('golfListComponent', {static : false}) golfListComponentRef: GolfListComponent;
  private docClickSubscription: any;
  public isLoading = false;
  public isSubmitted = false;
  @Select(GolfStateModule.getSearchCriteria) searchCriteria$: Observable<any>;
  searchSubject: Subject<any> = new Subject<any>();

  constructor(loginService: LoginService, private golfRetrieveService: GolfRetrieveService,
