...
import { AirlineOrderComponent } from './airline-order.component';
...
describe('AirlineOrderComponent', () => {
  let component: AirlineOrderComponent;
  let fixture: ComponentFixture<AirlineOrderComponent>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      declarations: [ AirlineOrderComponent ],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(AirlineOrderComponent);
