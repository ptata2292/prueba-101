...
import { SpaOrderComponent } from './spa-order.component';
...
describe('SpaOrderComponent', () => {
  let component: SpaOrderComponent;
  let fixture: ComponentFixture<SpaOrderComponent>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      declarations: [ SpaOrderComponent ],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(SpaOrderComponent);
