...
@Component({
  selector: 'app-spa-dashboard',
  templateUrl: './spa-dashboard.component.html',
  styleUrls: ['./spa-dashboard.component.css']
})
export class SpaDashboardComponent extends Spa implements OnInit, OnDestroy {
  public response = {};
  public spaData = {};
