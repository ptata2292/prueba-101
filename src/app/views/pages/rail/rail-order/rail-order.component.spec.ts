...
import { RailOrderComponent } from './rail-order.component';
...
describe('RailOrderComponent', () => {
  let component: RailOrderComponent;
  let fixture: ComponentFixture<RailOrderComponent>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      declarations: [ RailOrderComponent ],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(RailOrderComponent);
