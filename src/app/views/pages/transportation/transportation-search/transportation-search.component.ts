...
import { TransportationStateModule } from '../../../../store/transportation/transportation.state';
...
export class TransportationSearchComponent extends Transportation implements OnInit, AfterViewInit, OnDestroy {
  public response = {};
  ...
  @ViewChild('transportationListComponent', {static : false}) transportationListComponentRef: TransportationListComponent;
  private docClickSubscription: any;
  public isLoading = false;
  public isSubmitted = false;
  @Select(TransportationStateModule.getSearchCriteria) searchCriteria$: Observable<any>;
