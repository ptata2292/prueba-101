...
export class TransportationOrdersComponent extends Transportation implements OnInit, AfterViewInit  {
  ...
  search() {
    ...
    if(this.searchOrderFG.valid) {
      ...
      this.isLoading = true;
      this.transportationOrderService.gerOrderByName(value.FirstName, value.LastName).subscribe((data: any) => {
  ...
  searchById() {
    ...
    if(this.searchOrderIdFG.valid) {
      ...
      this.isLoading = true;
      this.transportationOrderService.gerOrderById(value.OrderId).subscribe((data: any) => {
        // console.log('gerOrderByName');
        // console.log(data);
        this.isLoading = false;
        let order = {
